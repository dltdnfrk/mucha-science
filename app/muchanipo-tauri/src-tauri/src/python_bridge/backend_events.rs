...
pub(super) fn emit_backend_line(app: &AppHandle, line: &str, app_run_id: &str) -> Option<String> {
...
pub(super) fn with_app_run_id(mut event: BackendEvent, app_run_id: &str) -> BackendEvent {
