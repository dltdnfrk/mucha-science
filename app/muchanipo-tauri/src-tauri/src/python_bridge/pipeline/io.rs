...
use super::super::{
    ...
    logging::{
        open_run_log, stderr_log_path_for_app_run_id, stdout_log_path_for_app_run_id,
    },
        ...
        match line {
            ...
            Ok(line) => {
                ...
                if let Some(tagged_line) =
                    emit_backend_line(&reader.app, &line, &reader.app_run_id)
                {
        ...
        match line {
            ...
            Ok(line) => {
                ...
                emit_backend_event(
                    &reader.app,
                    with_app_run_id(
                        stderr_line_to_backend_event(&line),
                        &reader.app_run_id,
                    ),
                );
            }
