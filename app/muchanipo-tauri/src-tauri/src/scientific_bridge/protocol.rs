...
pub(super) fn is_negotiated_scientific(bridge: &ScientificBridge) -> Result<bool, String> {
...
fn is_running_generation(state: &super::state::BridgeState, generation: u64) -> bool {
