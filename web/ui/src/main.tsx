...
class AppErrorBoundary extends React.Component<React.PropsWithChildren, AppErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, info: React.ErrorInfo) {
    ...
    console.error("MUNI lab React boot error", error, info.componentStack);
  }
...
if (!root) {
  ...
  document.body.innerHTML =
    '<pre style="white-space:pre-wrap;margin:0;padding:24px;color:#fecaca;background:#0d0e0e;min-height:100vh;box-sizing:border-box;font:13px ui-monospace,SFMono-Regular,Menlo,monospace">MUNI lab frontend boot error:\\n#root element is missing</pre>';
  throw new Error("MUNI lab root element is missing");
} else {
